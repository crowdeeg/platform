...
//   settings() {
//     const testerIds = Roles.getUsersInRole("tester")
//       .fetch()
//       .map((user) => user._id);
//     const assignments = Assignments.find({
//       users: { $nin: testerIds },
//     }).fetch();
...
//       assignment.source = renderAnnotationsImported(
//         assignment.annotationsImported
//       );
...
//         const annotationLabel = separateWithSpacesAndCapitalize(
//           annotation.type
//         );
//         annotationFields[annotationKey] = annotationLabel;
//         if (
//           assignment[annotationKey] === undefined ||
//           assignment[annotationKey] === null
//         ) {
